...
In my code, when running `python scripts/demo.py`:
1. the arm first tries to place the red tube on Rack B but misses and shows FAILED
2. then retries and places it correctly
